...
Реализовать конечный автомат, принимающий строки, задаваемые следующим регулярным выражением: [A-Z0-9._%+-]+@([A-Z0-9-]+\.)+[A-Z]. Примечание: \. означает символ ".". Точка внутри квадратных скобок — это тоже символ ".".
